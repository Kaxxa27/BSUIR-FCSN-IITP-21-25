...
MyDialogLine::MyDialogLine(QWidget *)
{
    this->setWindowTitle("Линия");
    this->setGeometry(600,250,325,150);

    QLabel *TextWeight = new QLabel(this);
    TextWeight->setText("Введите длину: ");
...
void Line::InfoAboutRect()
{
    ...
    InfoLabel->setText("Длина: " + QString::number(Perimetr)
...
int MyDialogLine::GETWeight()
{
    return LineWeight->value();
}
int MyDialogLine::RoX()
{
    return SpinRoX->value();
}

int MyDialogLine::RoY()
{
