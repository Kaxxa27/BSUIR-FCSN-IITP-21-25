...
MyDialogRomb::MyDialogRomb(QWidget *)
{
...
int MyDialogRomb::GETWeight()
{
    return LineWeight->value();
}
int MyDialogRomb::RoX()
{
    return SpinRoX->value();
}

int MyDialogRomb::RoY()
{
