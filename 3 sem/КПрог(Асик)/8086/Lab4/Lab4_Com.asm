...
; Данные программы 
    ...
    ;Info_Strings
    Start_Info_String db 'Start Programm$'   
    ...
    Find_String db 'jeka' ; Искомое слово 
    ...
    Size_FindString dw 4 ; Размер искомого слова
