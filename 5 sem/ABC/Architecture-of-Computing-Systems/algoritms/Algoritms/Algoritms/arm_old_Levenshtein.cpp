...
//    }
//
//    // Заполняем матрицу по правилам алгоритма с использованием NEON
...
//
//            // векторизированные операции с использованием NEON
...
//
//            //  Обновляем значение prev_diag
//           prev_diag = vgetq_lane_s32(vget_low_s32(replace), 3);
//        }
//    }
//
//    return dp[len1][len2];
...
//            << setw(15) << fixed << setprecision(2) << (double)durationL_NEON / durationL
//            << endl;
//
//        json resultObject;
//        resultObject["n"] = n;
