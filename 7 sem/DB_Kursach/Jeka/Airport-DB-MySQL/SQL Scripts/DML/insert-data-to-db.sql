...
('Engine Check', 'Comprehensive engine maintenance service', 250.00),
('Oil Replacement', 'Replacement of engine oil', 80.00),
('Cabin Cleaning', 'Full cleaning of aircraft cabin', 120.00),
('Software Update', 'Update aircraft navigation software', 300.00),
('Safety Inspection', 'Routine safety inspection', 150.00);

-- Заполнение таблицы plane_maintenance
INSERT INTO plane_maintenance (plane_id, maintenance_date, details) VALUES
(1, '2024-01-15', 'Performed engine diagnostics and oil change'),
(2, '2024-01-18', 'Cabin cleaning and safety inspection'),
(3, '2024-02-01', 'Navigation software update'),
(4, '2024-02-10', 'Landing gear inspection'),
(5, '2024-02-20', 'Electrical systems check');

-- Заполнение таблицы crew
INSERT INTO crew (first_name, last_name, position, nationality_id) VALUES
('John', 'Smith', 'Pilot', 1),
('Jane', 'Doe', 'Co-Pilot', 2),
('Michael', 'Brown', 'Flight Attendant', 3),
('Sara', 'Johnson', 'Flight Attendant', 4),
('Tom', 'Williams', 'Engineer', 1);

-- Заполнение таблицы crew_assignment
INSERT INTO crew_assignment (crew_id, flight_id, role) VALUES
(1, 1, 'Captain'),
(2, 2, 'First Officer'),
(3, 3, 'Lead Attendant'),
(4, 4, 'Cabin Crew'),
...
INSERT INTO route (source_airport_id, destination_airport_id, distance_km) VALUES
(1, 2, 1500.50),
(2, 3, 2000.00),
(3, 4, 750.75),
(4, 5, 1200.20),
...
INSERT INTO meal (name, description, price) VALUES
('Vegetarian Meal', 'A healthy vegetarian meal', 15.50),
('Chicken Sandwich', 'Sandwich with grilled chicken', 10.00),
('Pasta Primavera', 'Pasta with seasonal vegetables', 12.75),
('Beef Steak', 'Grilled steak with side vegetables', 18.00),
('Fruit Platter', 'Selection of fresh fruits', 8.50);

-- Заполнение таблицы ticket_meal
INSERT INTO ticket_meal (ticket_id, meal_id, quantity) VALUES
(1, 1, 2),
(1, 3, 1),
(2, 4, 1),
(3, 2, 3),
...
INSERT INTO payment (ticket_id, payment_date, amount, payment_method) VALUES
(1, '2024-03-01 10:00:00', 300.00, 'Credit Card'),
(2, '2024-03-02 12:30:00', 150.00, 'PayPal'),
(3, '2024-03-03 14:00:00', 450.00, 'Debit Card'),
(4, '2024-03-04 16:00:00', 200.00, 'Bank Transfer'),
(5, '2024-03-05 18:30:00', 500.00, 'Cash');

-- Заполнение таблицы review
INSERT INTO review (user_id, flight_id, rating, comments) VALUES
(1, 1, 5, 'Great experience, very smooth flight!'),
(2, 1, 4, 'Comfortable seating, but food could be better'),
(3, 2, 3, 'Flight was delayed, but service was okay'),
(4, 3, 5, 'Exceptional crew and clean cabin!'),
(5, 4, 4, 'Good value for money');

-- Заполнение таблицы notification
INSERT INTO notification (user_id, message, created_at, is_read) VALUES
(1, 'Your flight 101 is now boarding.', '2024-03-01 09:45:00', 0),
(2, 'Payment received for ticket 2.', '2024-03-02 12:31:00', 1),
(3, 'Your flight 103 has been rescheduled.', '2024-03-03 13:00:00', 0),
(4, 'Check-in now available for flight 104.', '2024-03-04 15:00:00', 0),
(5, 'Your ticket 5 payment confirmation.', '2024-03-05 18:31:00', 1);
